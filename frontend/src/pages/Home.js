      ...
      <div className=" container">
        ...
        <div className="">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            {/* Business Car */}
            <div className="grid border border-solid border-white rounded-2xl" style={{ background: 'linear-gradient(1turn, #f1f6fd 30%, #edf1f7)', boxShadow: '3px 3px 9px rgba(164, 164, 186, 0.2)' }}>
              <img className="static inline-block rounded-2xl" src={business} alt="" />
              <div className="grid justify-between items-center p-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 py-10"> {/* start of 2nd row of car types */}
          <div className="grid"> 
            <div>
              <img
                  className="static inline-block rounded-2xl"
